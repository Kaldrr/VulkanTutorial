  ...
  foreach(shader ${shaders})
    ...
    add_custom_command(
      ...
      COMMAND
        ...
        "${CMAKE_CURRENT_SOURCE_DIR}/${shader}" "-O" "-o" "${OUT_SHADER_FILE}"
...
function(add_model_dependency models)
  add_custom_command(
    TARGET VulkanTutorial
    PRE_BUILD
    COMMAND ${CMAKE_COMMAND} -E make_directory "Models")
  foreach(model ${models})
    add_custom_command(
      OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${model}"
      COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_SOURCE_DIR}/${model}
  ...
  add_dependencies(VulkanTutorial models)
endfunction()
...
function(add_textures_dependency textures)
  ...
  foreach(texture ${textures})
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy "${CMAKE_CURRENT_SOURCE_DIR}/${texture}"
  ...
  add_dependencies(VulkanTutorial textures)
endfunction()
